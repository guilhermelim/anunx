...
const ToggleButtonGroupColorMode = () => {
  ...
  return (
    <Box >
      ...
      >
        <ToggleButton value="light"><LightModeIcon /> Claro</ToggleButton>
        <ToggleButton value="system"><SettingsBrightnessIcon /> Sistema</ToggleButton>
        <ToggleButton value="dark"><DarkModeOutlinedIcon /> Escuro</ToggleButton>
      </ToggleButtonGroup>
    </Box>
  )
}
